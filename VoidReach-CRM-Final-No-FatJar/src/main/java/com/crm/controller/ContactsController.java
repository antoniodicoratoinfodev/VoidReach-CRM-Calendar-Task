...
public final class ContactsController {
    ...
    public ContactsController(TableView<Contact> table,
                              ...
                              Button selectContactsButton, ThemeService themeService,
    ...
    public void initialize() {
        ...
        table.setRowFactory(ignored -> {
            ...
            row.setOnMouseClicked(event -> {
                if (!selectionMode && event.getClickCount() == 2 && !row.isEmpty()) showContactDialog(row.getItem());
            });
            return row;
        });
    ...
    public void showAll() { rowsPerPageCombo.setValue("All"); }
    ...
    private void updateTablePage() {
        ...
        int total = filteredContacts.size();
        if (selected.equals("All")) {
            table.setItems(FXCollections.observableArrayList(filteredContacts));
        ...
        if (from >= total) {
            ...
            table.setItems(FXCollections.observableArrayList(filteredContacts.subList(from, to)));
